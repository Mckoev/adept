...
function App() {
    ...
    return (
        <div className="App">
            <TableCompany column1={TABLE_COLUMN_NAMES.COMPANY_NAME} column2={TABLE_COLUMN_NAMES.AMOUNT_WORKERS}
                          column3={TABLE_COLUMN_NAMES.ADDRESS}/>
            <TableWorkers column1={TABLE_COLUMN_NAMES.NAME_WORKER} column2={TABLE_COLUMN_NAMES.SURNAME_WORKER}
